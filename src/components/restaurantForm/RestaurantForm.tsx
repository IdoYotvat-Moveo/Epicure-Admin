...
import { BasicDish, Chef, Dish, Restaurant } from "../../data/types"
import { useState } from "react"
import { StyledForm, StyledSubmitBtn } from "../chefForm/style"

interface RestaurantFormProps {
    chefs: Chef[]
    dishes: Dish[] | BasicDish[]
...
return (
    <StyledForm onSubmit={submitHandler} onBlur={() => handleClose}>
        ...
        <Rating
            ...
            onChange={(_, newValue) => handleRatingChange(newValue, 'rating')}
        />
        ...
        <Select
            ...
            value={formData.signatureDish as string || 'N/A'}
            onChange={handleChange}
            input={<OutlinedInput label="SignatureDish" />}
        >
            <MenuItem value="N/A">N/A</MenuItem>
            {(formData.dishes as string[]).map((dish) => (
